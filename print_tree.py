...
def print_tree(root_path, file_handle, prefix='', exclude_dirs=None):
    ...
    entries = [e for e in entries if os.path.isdir(os.path.join(root_path, e)) or os.path.isfile(os.path.join(root_path, e))]
...
if __name__ == "__main__":
    ...
    excluded = ['node_modules', '__pycache__', '.git']  # Các thư mục cần loại trừ
