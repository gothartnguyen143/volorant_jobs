...
<div id="add-new-account-modal" hidden class="QUERY-modal fixed inset-0 flex items-center justify-center z-90 p-4">
  ...
  <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto relative z-20 CSS-styled-scrollbar">
    ...
    <form id="add-new-account-form" class="px-6 py-4">
      <div id="pick-avatar--add-section" class="QUERY-at-avatar-input-section mb-4">
    ...
    <div class="p-6 border-t border-gray-200 flex justify-end gap-3">
      <button id="add-new-account-cancel-btn" class="px-4 py-2 text-gray-700 bg-gray-200 hover:scale-110 rounded-lg transition">
        Hủy
      </button>
      <button id="add-new-account-submit-btn" class="px-4 py-2 bg-gradient-to-r from-regular-from-blue-cl to-regular-to-blue-cl hover:scale-110 text-white rounded-lg transition flex items-center gap-2">
