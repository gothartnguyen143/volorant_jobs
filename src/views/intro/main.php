  ...
  <div class="QUERY-right-side-container">
    <div class="flex flex-col min-[700px]:items-end space-y-4 items-center">
      <div class="flex items-center gap-2 px-4 py-2 bg-blue-600/20 w-fit backdrop-blur-sm rounded-full border border-blue-500/30">
        ...
        <span class="text-blue-300 text-[1em] font-medium">VALORANT ACCOUNTS</span>
      </div>

      <h1 class="text-[1.71em] lg:text-[2.29em] font-bold text-white min-[700px]:text-right leading-tight space-y-2 text-center">
        THUÊ ACC
    ...
    <div class="flex justify-end gap-16 mt-4">
      <div class="text-center">
        <div class="text-[1.71em] font-bold text-white">98%</div>
        <div class="text-gray-400 text-[1em]">Hài lòng</div>
      </div>
      <div class="text-center">
